...
export const Symfoni: React.FC<SymfoniProps> = ({
    ...
    const getSigner = useCallback(async (_provider: providers.Provider) => {
                                            ...
                                            <Box>
                                                {walletConnectURI ?
                                                    <Box>
                                                        ...
                                                        <Image src={`${"https://chart.googleapis.com/chart?cht=qr&chs=200x200&chl=" + walletConnectURI}`} ></Image>
                                                        <Box direction="row" gap="small">
                                                            <TextInput size="xsmall" value={walletConnectURI}></TextInput>
                                                            <Button icon={<Copy></Copy>} label="Copy" onClick={(e) => copy(walletConnectURI)}></Button>
                                                        </Box>
                                                    </Box>
